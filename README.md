...
### [9. User](https://github.com/vpnchengo/AirBnB_clone_v3/blob/master/api/v1/views/user.py)
...
```
### [13. Place - Amenity](https://github.com/vpnchengo/AirBnB_clone_v3/blob/master/api/v1/views/places_amenities.py)
