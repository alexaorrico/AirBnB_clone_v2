...
<img src="https://user-images.githubusercontent.com/113856302/233853216-e611571d-e31d-4aec-9b75-8a4247bc0681.gif" width="100%">

## Synopsis

>We worked on a group project at **[Holberton School](https://www.holbertonschool.fr)**, which involved creating an **Airbnb clone RESTful API**. This project was developed by **[Mathieu Morel](https://github.com/MathieuMorel62)** and **[Caroline Chochoy](https://github.com/CaroChoch)**, and we worked together to provide a comprehensive understanding of RESTful APIs using Python and Flask.
   
>In this project, we explored the concepts of REST and API, including their meaning, features, and functionality. We also covered topics such as HTTP access control (CORS), Flask blueprints, and Flask tests.
   
>We worked hard to create this RESTful API, using HTTP methods such as retrieving, creating, updating, and deleting resources. We also gained a deep understanding of the different types of APIs, as well as the meaning of REST, API, and CORS.
    
>This project allowed us to gain hands-on experience in creating a RESTful API and making requests to a RESTful API.

## Installation

```shell
https://github.com/MathieuMorel62/holbertonschool-AirBnB_clone_v3.git
```
...
## More Info
<img src="https://user-images.githubusercontent.com/113856302/233850774-fdd57224-e0f9-4820-a7c0-1f228dadb7ff.png"
 width="100%">
...
### [0. Restart From Scratch!](https://github.com/MathieuMorel62/holbertonschool-AirBnB_clone_v3)
...
### [1. Never Fail!](https://github.com/MathieuMorel62/holbertonschool-AirBnB_clone_v3/tree/master/tests)
...
```sql
caroline@ubuntu:~/AirBnB_v3$ python3 -m unittest discover tests 2>&1 | tail -1
OK
caroline@ubuntu:~/AirBnB_v3$ HBNB_ENV=test HBNB_MYSQL_USER=hbnb_test HBNB_MYSQL_PWD=hbnb_test_pwd HBNB_MYSQL_HOST=localhost HBNB_MYSQL_DB=hbnb_test_db HBNB_TYPE_STORAGE=db python3 -m unittest discover tests 2>&1 /dev/null | tail -n 1
OK
```

----------------------
  
### [2. Code Review](https://github.com/MathieuMorel62/holbertonschool-AirBnB_clone_v3/tree/storage_get_count)
Like “tests”, code review is the base of all software development.
   
All companies are using this “feature” to improve the codebase, but also the group dynamic. For example, at [Zenly](https://zenly.com), the iOS team does a code review everyday at 5pm with the entire team.
...
<img src="https://user-images.githubusercontent.com/113856302/233854214-5634808d-70e8-481e-8079-ab240e3abe90.png">

**Examples of good reviews**

<img src="https://user-images.githubusercontent.com/113856302/233854274-f7772b5f-b69c-434a-915d-469eda1f0dd5.png">
  
--------------------------
  
### [3. Improve Storage](https://github.com/MathieuMorel62/holbertonschool-AirBnB_clone_v3/tree/storage_get_count)
Update [DBStorage](https://github.com/MathieuMorel62/holbertonschool-AirBnB_clone_v3/blob/storage_get_count/models/engine/db_storage.py) and [FileStorage](https://github.com/MathieuMorel62/holbertonschool-AirBnB_clone_v3/blob/storage_get_count/models/engine/file_storage.py), adding two new methods. **All changes should be done in the branch `storage_get_count`**:
...
```python
mathieu@ubuntu:~/AirBnB_v3$ cat test_get_count.py
#!/usr/bin/python3
...
```mysql
mathieu@ubuntu:~/AirBnB_v3$
mathieu@ubuntu:~/AirBnB_v3$ HBNB_MYSQL_USER=hbnb_dev HBNB_MYSQL_PWD=hbnb_dev_pwd HBNB_MYSQL_HOST=localhost HBNB_MYSQL_DB=hbnb_dev_db HBNB_TYPE_STORAGE=db ./test_get_count.py 
All objects: 1013
State objects: 27
...
mathieu@ubuntu:~/AirBnB_v3$
mathieu@ubuntu:~/AirBnB_v3$ ./test_get_count.py 
All objects: 19
State objects: 5
...
### [4. Status Of Your API](https://github.com/MathieuMorel62/holbertonschool-AirBnB_clone_v3/tree/master/api)
It’s time to start your API!
   
Your first endpoint (route) will be to return the status of your API:
  
```sql
mathieu@ubuntu:~/AirBnB_v3$ HBNB_MYSQL_USER=hbnb_dev HBNB_MYSQL_PWD=hbnb_dev_pwd HBNB_MYSQL_HOST=localhost HBNB_MYSQL_DB=hbnb_dev_db HBNB_TYPE_STORAGE=db HBNB_API_HOST=0.0.0.0 HBNB_API_PORT=5000 python3 -m api.v1.app
...
```python
mathieu@ubuntu:~/AirBnB_v3$ curl -X GET http://0.0.0.0:5000/api/v1/status
{
  "status": "OK"
}
  
mathieu@ubuntu:~/AirBnB_v3$ 
mathieu@ubuntu:~/AirBnB_v3$ curl -X GET -s http://0.0.0.0:5000/api/v1/status -vvv 2>&1 | grep Content-Type
...
- Create a folder [v1](https://github.com/MathieuMorel62/holbertonschool-AirBnB_clone_v3/tree/master/api/v1) inside [api](https://github.com/MathieuMorel62/holbertonschool-AirBnB_clone_v3/tree/master/api):
  - create an empty file `__init__.py`
  - create a file [app.py](https://github.com/MathieuMorel62/holbertonschool-AirBnB_clone_v3/blob/master/api/v1/app.py):
    ...
    - inside `if __name__ == "__main__":`, run your Flask server (variable `app`) with:
      ...
      - `threaded=True`
- Create a folder [views](https://github.com/MathieuMorel62/holbertonschool-AirBnB_clone_v3/tree/master/api/v1/views) inside [v1](https://github.com/MathieuMorel62/holbertonschool-AirBnB_clone_v3/tree/master/api/v1):
  ...
  - create a file [index.py](https://github.com/MathieuMorel62/holbertonschool-AirBnB_clone_v3/blob/master/api/v1/views/index.py)
    - import `app_views` from `api.v1.views`
    - create a route `/status` on the object `app_views` that returns a JSON: `"status": "OK"` (see example)

-----------------
  
### [5. Some Stats?](https://github.com/MathieuMorel62/holbertonschool-AirBnB_clone_v3/blob/master/api/v1/views/index.py)
...
```python
caroline@ubuntu:~/AirBnB_v3$ curl -X GET http://0.0.0.0:5000/api/v1/stats
{
  "amenities": 47, 
  "cities": 36, 
  "places": 154, 
...
### [6. Not Found](https://github.com/MathieuMorel62/holbertonschool-AirBnB_clone_v3/blob/master/api/v1/app.py)
...
```python
mathieu@ubuntu:~/AirBnB_v3$ curl -X GET http://0.0.0.0:5000/api/v1/nop
{
  "error": "Not found"
}
  
mathieu@ubuntu:~/AirBnB_v3$ curl -X GET http://0.0.0.0:5000/api/v1/nop -vvv
*   Trying 0.0.0.0...
* TCP_NODELAY set
...
### [7. State](https://github.com/MathieuMorel62/holbertonschool-AirBnB_clone_v3/blob/master/api/v1/views/states.py)
...
```mysql
mathieu@ubuntu:~/AirBnB_v3$ curl -X GET http://0.0.0.0:5000/api/v1/states/
[
  {
    "__class__": "State", 
...
mathieu@ubuntu:~/AirBnB_v3$ 
mathieu@ubuntu:~/AirBnB_v3$ curl -X GET http://0.0.0.0:5000/api/v1/states/8f165686-c98d-46d9-87d9-d6059ade2d99
 {
  "__class__": "State", 
  "created_at": "2017-04-14T00:00:02", 
  "id": "8f165686-c98d-46d9-87d9-d6059ade2d99", 
...
mathieu@ubuntu:~/AirBnB_v3$ 
mathieu@ubuntu:~/AirBnB_v3$ curl -X POST http://0.0.0.0:5000/api/v1/states/ -H "Content-Type: application/json" -d '{"name": "California"}' -vvv
*   Trying 0.0.0.0...
* TCP_NODELAY set
* Connected to 0.0.0.0 (127.0.0.1) port 5000 (#0)
...
mathieu@ubuntu:~/AirBnB_v3$ 
mathieu@ubuntu:~/AirBnB_v3$ curl -X PUT http://0.0.0.0:5000/api/v1/states/feadaa73-9e4b-4514-905b-8253f36b46f6 -H "Content-Type: application/json" -d '{"name": "California is so cool"}'
{
  "__class__": "State", 
...
mathieu@ubuntu:~/AirBnB_v3$ 
mathieu@ubuntu:~/AirBnB_v3$ curl -X GET http://0.0.0.0:5000/api/v1/states/feadaa73-9e4b-4514-905b-8253f36b46f6
{
  "__class__": "State", 
  "created_at": "2017-04-15T01:30:28", 
  "id": "feadaa73-9e4b-4514-905b-8253f36b46f6", 
...
mathieu@ubuntu:~/AirBnB_v3$ 
mathieu@ubuntu:~/AirBnB_v3$ curl -X DELETE http://0.0.0.0:5000/api/v1/states/feadaa73-9e4b-4514-905b-8253f36b46f6
{}
...
### [8. City](https://github.com/MathieuMorel62/holbertonschool-AirBnB_clone_v3/blob/master/api/v1/views/cities.py)
...
```mysql
caroline@ubuntu:~/AirBnB_v3$ curl -X GET http://0.0.0.0:5000/api/v1/states/not_an_id/cities/
{
  "error": "Not found"
}
  
  
caroline@ubuntu:~/AirBnB_v3$ 
caroline@ubuntu:~/AirBnB_v3$ curl -X GET http://0.0.0.0:5000/api/v1/states/2b9a4627-8a9e-4f32-a752-9a84fa7f4efd/cities
[
  {
    "__class__": "City", 
...
caroline@ubuntu:~/AirBnB_v3$ 
caroline@ubuntu:~/AirBnB_v3$ curl -X GET http://0.0.0.0:5000/api/v1/cities/1da255c0-f023-4779-8134-2b1b40f87683
{
  "__class__": "City", 
  "created_at": "2017-03-25T02:17:06", 
  "id": "1da255c0-f023-4779-8134-2b1b40f87683", 
...
caroline@ubuntu:~/AirBnB_v3$ 
caroline@ubuntu:~/AirBnB_v3$ curl -X POST http://0.0.0.0:5000/api/v1/states/2b9a4627-8a9e-4f32-a752-9a84fa7f4efd/cities -H "Content-Type: application/json" -d '{"name": "Alexandria"}' -vvv
*   Trying 0.0.0.0...
* TCP_NODELAY set
* Connected to 0.0.0.0 (127.0.0.1) port 5000 (#0)
...
caroline@ubuntu:~/AirBnB_v3$ 
caroline@ubuntu:~/AirBnB_v3$ curl -X PUT http://0.0.0.0:5000/api/v1/cities/b75ae104-a8a3-475e-bf74-ab0a066ca2af -H "Content-Type: application/json" -d '{"name": "Bossier City"}'
{
  "__class__": "City", 
...
caroline@ubuntu:~/AirBnB_v3$ 
caroline@ubuntu:~/AirBnB_v3$ curl -X GET http://0.0.0.0:5000/api/v1/cities/b75ae104-a8a3-475e-bf74-ab0a066ca2af
{
  "__class__": "City", 
  "created_at": "2017-04-16T03:14:06", 
  "id": "b75ae104-a8a3-475e-bf74-ab0a066ca2af", 
...
caroline@ubuntu:~/AirBnB_v3$ 
caroline@ubuntu:~/AirBnB_v3$ curl -X DELETE http://0.0.0.0:5000/api/v1/cities/b75ae104-a8a3-475e-bf74-ab0a066ca2af
{}
...
### [9. Amenity](https://github.com/MathieuMorel62/holbertonschool-AirBnB_clone_v3/blob/master/api/v1/views/amenities.py)
...
### [10. User](https://github.com/MathieuMorel62/holbertonschool-AirBnB_clone_v3/blob/master/api/v1/views/users.py)
...
### [11. Place](https://github.com/MathieuMorel62/holbertonschool-AirBnB_clone_v3/blob/master/api/v1/views/places.py)
...
### [12. Reviews](https://github.com/MathieuMorel62/holbertonschool-AirBnB_clone_v3/blob/master/api/v1/views/places_reviews.py)
...
### [13. HTTP Access Control (CORS)](https://github.com/MathieuMorel62/holbertonschool-AirBnB_clone_v3/blob/master/api/v1/app.py)
...
```python
mathieu@ubuntu:~/AirBnB_v3$ curl -X GET http://0.0.0.0:5000/api/v1/cities/1da255c0-f023-4779-8134-2b1b40f87683 -vvv
*   Trying 0.0.0.0...
* TCP_NODELAY set
* Connected to 0.0.0.0 (127.0.0.1) port 5000 (#0)
...
### [14. Place - Amenity](https://github.com/MathieuMorel62/holbertonschool-AirBnB_clone_v3/blob/master/api/v1/views/places_amenities.py)
...
```mysql
mathieu@ubuntu:~/AirBnB_v3$ curl -X POST http://0.0.0.0:5000/api/v1/places_search -H "Content-Type: application/json" -d '{"states": ["2b9a4627-8a9e-4f32-a752-9a84fa7f4efd", "459e021a-e794-447d-9dd2-e03b7963f7d2"], "cities": ["5976f0e7-5c5f-4949-aae0-90d68fd239c0"]}'
[
  {
    "__class__": "Place", 
    "created_at": "2017-03-25T02:17:06", 
...
Add comments on each endpoint of your API, so you can view the documentation in your browser: `http://0.0.0.0:5000/apidocs`
 ...
 <img src="https://user-images.githubusercontent.com/113856302/233858792-fadfe8b5-b4fa-4464-9f6d-4dafcdb47370.png">
