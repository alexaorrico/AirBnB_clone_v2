...
class TestFileStorage(unittest.TestCase):
    ...
    def test_get(self):
        ...
        newStateInstance.save()
        newStateInstanceId = newStateInstance.id
        self.assertTrue(storage.get(type(newStateInstance),
                        newStateInstanceId) is not None)
        self.assertTrue(storage.get(type(newStateInstance),
                        "57575757575757") is None)
