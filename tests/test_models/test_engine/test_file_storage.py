...
class TestFileStorage(unittest.TestCase):
    ...
    def test_save(self):
        ...
        with open("file.json", "r") as f:
            js = f.read()
        self.assertEqual(json.loads(js), self.storage._FileStorage__objects)
    ...
    def test_delete(self):
        ...
        self.assertNotIn(instance, self.storage.all().values())
    ...
    def test_get(self):
        """Test that get returns the object based on class name and ID"""
        instance = State()
        self.storage.new(instance)
        self.storage.save()
        result = self.storage.get(State, instance.id)
    ...
    def test_count_with_cls(self):
        """Test that count returns the number of objects of a specific class in storage"""
        instance1 = State()
        instance2 = State()
