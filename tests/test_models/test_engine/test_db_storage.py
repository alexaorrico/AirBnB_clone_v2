...
class TestFileStorage(unittest.TestCase):
    ...
    @unittest.skipIf(models.storage_t != 'db', "not testing storage")
    def test_count(self):
        """This test accurately count the number of objects"""
    ...
    @unittest.skipIf(models.storage_t != 'db', "not testing db storage")
    def test_get(self):
        """This test returns valid id from the get function"""
        models.storage.reload()
        user = User(email="1@2.com", password="1234")
        models.storage.new(user)
        models.storage.save()
        user_id = user.id
        wrong_id = '666'
