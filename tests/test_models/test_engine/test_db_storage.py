...
class TestDBStorage(unittest.TestCase):
    ...
    def test_get(self):
        ...
        new_state.save()
        new_user = User(email="identity@obj.com", password="p@$$word")
        new_user.save()
        self.assertIs(new_state, models.storage.get("State", new_state.id))
        self.assertIs(None, models.storage.get("State", "zxcv"))
        self.assertIs(None, models.storage.get("zxcv", "zxcv"))
    ...
    def test_count(self):
        ...
        self.assertEqual(models.storage.count("xyz"), 0)
