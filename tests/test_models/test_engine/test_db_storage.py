...
@unittest.skipIf(storage_type != 'db', 'skip if environ not db')
class TestStorageGet(unittest.TestCase):
    ...
    def test_get_method_return(self):
        ...
        :return True if pass, fasle if not pass
        """
        result = storage.get(cls="state", id=str(self.state.id)

        self.assertEqual(self.state.id, results.id)
...
class TestStorageCount(unittest.TestCase):
   ...
   def test_count_state(self):
       ...
       :return: True if pass, flase if not pass
       """
   ...
   def test_count_city(self):
       """
       testing counting non existenet
       :return: True if pass, false if not pass
       """
