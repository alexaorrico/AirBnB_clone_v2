...
test_db_storage.py"
    ...
    def test_db_storage_module_docstring(self):
        ...
        msg = "db_storage.py needs a docstring"
        self.assertIsNot(db_storage.__doc__, None, msg)
        self.assertTrue(len(db_storage.__doc__) >= 1, msg)

    def test_db_storage_class_docstring(self):
        """Test for the DBStorage class docstring"""
        msg = "DBStorage class needs a docstring"
        self.assertIsNot(DBStorage.__doc__, None, msg)
        self.assertTrue(
            len(DBStorage.__doc__) >= 1, msg
        )
