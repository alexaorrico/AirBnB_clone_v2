...
class TestDBStorage(unittest.TestCase):
    ...
    def test_get(self):
        ...
        new_state.save()
        new_user = User(email="mesh@testmix.com", password="password")
        new_user.save()
        self.assertIs(new_state, models.storage.get("State", new_state.id))
        self.assertIs(None, models.storage.get("State", "Alx"))
        self.assertIs(None, models.storage.get("Down", "Town"))
    ...
    def test_count(self):
        ...
        self.assertEqual(models.storage.count("Alx"), 0)
        new_state = State(name="Chicago")
        new_state.save()
        new_user = User(email="mesh@testmix.com", password="password")
        new_user.save()
