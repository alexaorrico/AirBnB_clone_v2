...
class TestDBStorageDocs(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.user_obj = User(name="John", email="john@example.com")
        self.db_storage.new(self.user_obj)
        self.db_storage.save()

    def test_get_object(self):
        retrieved_user = self.db_storage.get(User, self.user_obj.id)
        self.assertEqual(retrieved_user, self.user_obj)
