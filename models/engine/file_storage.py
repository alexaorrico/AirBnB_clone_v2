...
class FileStorage:
    ...
    def count(self, cls=None):
        """
        Counts the number of objects in storage matchig the given class

        Args:
            cls: class

        Returns:
                Number of objects in storage or the count of all objects
                in storage if no class is passed.
        """
        if cls is None:
