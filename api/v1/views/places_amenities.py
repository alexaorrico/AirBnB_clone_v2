#!/usr/bin/python3
""" handle all default RestFul API actions for Place - Amenity """
...
def get_place_amenities(place_id):
    """
    get the list of all Amenity objects of a Place
    """
...
def delete_place_amenity(place_id, amenity_id):
    """
    Deleting a Amenity object of a Place
    """
    place = storage.get(Place, place_id)
...
def post_place_amenity(place_id, amenity_id):
    """
    Linking a Amenity object to a Place
    """
    place = storage.get(Place, place_id)
