#!/usr/bin/python3
"""
This module defines the API endpoints related to Place-Amenity relationships.
"""
...
if getenv('HBNB_TYPE_STORAGE') == 'db':
    ...
    def list_amenities_of_place(place_id):
        """
        Retrieves a list of all Amenity objects associated with a Place.
        """
    ...
    def create_place_amenity(place_id, amenity_id):
        """
        Creates an association between a Place and an Amenity.
        """
        all_places = storage.all("Place").values()
        place_obj = [obj.to_dict() for obj in all_places if obj.id == place_id]
        if place_obj == []:
    ...
    def delete_place_amenity(place_id, amenity_id):
        """
        Deletes the association between a Place and an Amenity.
        """
        all_places = storage.all("Place").values()
        place_obj = [obj.to_dict() for obj in all_places if obj.id == place_id]
        if place_obj == []:
