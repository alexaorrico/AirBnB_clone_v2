#!/usr/bin/python3
"""Module that handles all RESTFul API action on amenities"""
...
def amenities():
    """Retrieves a list of all amenitie"""

    all_amenities = storage.all(Amenity).values()
    list_amenities = []

    for amount in all_amenities:
        list_amenities.append(amount.to_dict())
