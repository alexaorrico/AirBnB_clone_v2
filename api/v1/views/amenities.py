#!/usr/bin/python3
"""
    RESTful API action handler for class Amenity
"""
...
def get_amenities():
    """retrieves all amenity objects in json form"""
...
def get_amenity_id(amenity_id):
    """returns amenity matching with the given id using http verb GET"""
...
def delete_amenity(amenity_id):
    """deletes amenity obj with matching the given amenity_id"""
    amenity = storage.get("Amenity", amenity_id)
    if amenity is None:
        abort(404)
    amenity.delete()
