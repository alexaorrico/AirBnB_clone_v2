...
def amenities():
    """Return all Amenities in the storage"""
...
def amenity_by_id(amenity_id):
    """Get the Amenity object that matches the id=amenity_id"""
...
def delete_amenity(amenity_id):
    """Delete the Amenity object that matches the id=amenity_id"""
...
def update_amenity_by_id(amenity_id):
    """Update the Amenity object that matches the id=amenity_id"""
    amenity = storage.get(Amenity, amenity_id)
    if amenity is None:
        abort(404)
    body = request.get_json()
