...
def places_search():
    """This search places according to the parameters.
    """
    if request.is_json:
...
def places_by_city_requests(city_id):
    """This method performs API requests of places by city
    """
...
def place_methods(place_id=None):
    """This method request api request
    """
    if request.method == 'GET':
