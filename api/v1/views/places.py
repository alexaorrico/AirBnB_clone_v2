...
def places_per_city(city_id=None):
    """ Places Route -> Handle HTTP method for Requested places by city """
...
def places_with_id(place_id=None):
    """ Places Route -> handle HTTP methods for given place """
...
def places_search():
    """ Places Route -> Handle HTTP method for Request -> Search Places """
