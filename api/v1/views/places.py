#!/usr/bin/python3
'''
Creates a view for Place objects, handling default RESTful API actions.
'''
...
def not_found(error):
    '''
    Returns a 404 error if a resource is not found.
    '''
...
def bad_request(error):
    '''
    Returns a 400 error for bad requests to the API.
    '''
