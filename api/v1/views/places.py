...
def get_all_places(city_id):
    """This function list cities by id """
...
def search_places_by_id():
    """This model searches places by id """
    ...
    if amenities:
        ...
        list_places = [place for place in list_places
                       if all([a in place.amenities
                               for a in amenities_obj])]
