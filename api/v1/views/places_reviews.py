...
def retrieve_reviews(place_id):
    '''Retrieves a particular place review using its place_id'''
...
def retrieve_review(review_id):
    '''Retrieves a particular review using its review_id'''
...
def delete_review(review_id):
    '''Deletes a particular review using its review_id'''
    review = storage.get("Review", review_id)
    if review is None:
        abort(404)
    review.delete()
