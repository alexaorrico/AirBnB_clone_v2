...
@swag_from('documentation/states_no_id.yml', methods=['GET', 'POST'])
def handle_states_no_id():
    """
...
@swag_from('documentation/states_id.yml', methods=['PUT', 'GET', 'DELETE'])
def handle_states_with_id(state_id=None):
    """
