...
@app_views.route("/states", methods=["GET"], strict_slashes=True)
def list_all_states():
    """Lists all states"""
...
@app_views.route("states/<state_id>", methods=["GET"], strict_slashe=True)
...
@app_views.route("/states", methods=["POST"], strict_slashes=True)
def create_state():
    """Creates a new state"""
