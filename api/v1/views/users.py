...
def users():
    """Get all User objects in the storage"""
...
def user_by_id(user_id):
    """Get a User object identified by id=user_id"""
...
def delete_user(user_id):
    """Delete an User object by id=user_id"""
...
def insert_user():
    """creates a new record for a new User object"""
...
def update_user_by_id(user_id):
    """Updates a User object identified with id=user_id"""
    user = storage.get(User, user_id)
    if user is None:
        abort(404)
    body = request.get_json()
