#!/usr/bin/python3
'''
    Create a view for User objects - handles all default RESTful API actions
'''
...
def get_user_id(user_id):
    '''
        Returns user with given id using http verb GET
    '''
...
def delete_user(user_id):
    '''
        deletes a user object given user_id
    '''
    user = storage.get("User", user_id)
    if user is None:
        abort(404)
